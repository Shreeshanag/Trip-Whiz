...
conn.execute("CREATE TABLE admin(username varchar,password varchar)")
conn.execute("CREATE TABLE flightbooking(ffrom varchar,fto varchar,dep date,freturn date,round varchar,oneway varchar)")
